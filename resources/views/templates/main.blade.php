...
<head>
    ...
    <link rel="stylesheet" type="text/css"
          href="{{ asset('assets/css/fonts/material-design-iconic-font/css/material-design-iconic-font.min.css') }}">
    <!-- Main Style Css -->
    <link rel="stylesheet" href="{{ asset('assets/css/style.css') }}"/>
    <script src="{{ asset('assets/js/bootstrap.min.css') }}" defer></script>
</head>
<body class="form-v10">
<div class="form-right">
    <img src="{{ asset('assets/images/urspi_new.png') }}" width="128px" alt="#">
</div>
        ...
        <form class="form-detail" action="#" method="post" id="myform">
            <div class="form-left">
                ...
                <div class="form-group">
                    <div class="form-row form-row-3">
                        <input type="text" name="business" class="business" id="business" placeholder="Business Arena"
                               required>
                    </div>
            ...
            <div class="form-right">
                ...
                <div class="form-checkbox">
                    <label class="container"><p>I do accept the <a href="#" class="text">Terms and Conditions</a> of
                            your site.</p>
